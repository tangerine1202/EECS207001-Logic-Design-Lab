...
set_property PACKAGE_PIN V14 [get_ports {stop}]
...
# set_property PACKAGE_PIN N3 [get_ports {tone_idx[3]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {tone_idx[3]}]
# set_property PACKAGE_PIN P1 [get_ports {tone_idx[4]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {tone_idx[4]}]
# set_property PACKAGE_PIN L1 [get_ports {speed_state}]
# set_property IOSTANDARD LVCMOS33 [get_ports {speed_state}]
